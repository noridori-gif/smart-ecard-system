...
export default function FinancialSuiteDashboard({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [notice, setNotice] = useState(""); const [mode, setMode] = useState<"pledge" | "payment" | "history" | "import" | null>(null);
