...
export default function FinancialSuiteDashboard({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [notice, setNotice] = useState(""); const [mode, setMode] = useState<"pledge" | "payment" | "history" | "import" | "bulk" | "reminder" | null>(null);
