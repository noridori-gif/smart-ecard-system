...
export type PortalData = {
  ...
  permissions: Record<string, boolean>; summary: FinanceSummary; finance_target: Partial<FinanceSummary> | null; pledges: FinancialPledge[];
};
