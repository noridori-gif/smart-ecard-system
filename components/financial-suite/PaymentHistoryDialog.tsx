...
export default function PaymentHistoryDialog({ payments, language="sw", issueReceipt, editPayment, onClose }: {
  ...
  editPayment?:(payment:PledgePayment)=>void; onClose:()=>void;
}) {
