...
export default function FinancialRemindersTab({ eventId, eventDate, deadline, pledges }: { eventId: number; eventDate: string; deadline: string | null; pledges: FinancialPledge[] }) {
  ...
  return <div className="space-y-5">
    ...
    {section === "operations" && <section className="rounded-2xl border border-stone-200 bg-white p-4 shadow-sm sm:p-6"><h2 className="text-xl font-bold">Reminder Operations</h2><p className="mt-1 text-sm text-slate-600">Monitor message delivery and retry state without exposing provider payloads.</p>
