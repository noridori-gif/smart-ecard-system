export default function StatStrip({
  ...
  return (
    <div className="sep-card p-2.5 sm:p-3" role="group" aria-label="Live attendance summary">
      ...
      <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-stone-100" role="progressbar" aria-label="Overall attendance" aria-valuemin={0} aria-valuemax={totalGuests} aria-valuenow={checkedIn}>
