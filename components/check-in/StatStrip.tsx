export default function StatStrip({
  ...
  return (
    <div className="sep-card p-4 sm:p-5" role="group" aria-label="Live attendance summary">
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-stone-100" role="progressbar" aria-label="Overall attendance" aria-valuemin={0} aria-valuemax={totalGuests} aria-valuenow={checkedIn}>
