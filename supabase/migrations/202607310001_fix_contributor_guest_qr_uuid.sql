-- Forward-only fix for UUID-compatible contributor guest QR tokens.
...
begin
  ...
  if pledge.guest_id is not null then
    ...
    if candidate_count > 1 then
      ...
      values(pledge.event_id,pledge.full_name,pledge.phone,pledge.email,'Normal',desired,'pending',pass_id,extensions.gen_random_uuid())
